...
export const lightingConfig: LightingConfig = {
  ...
  pointLights: [
    ...
    { name: 'right-wall-glow-1', position: [8, 4, 0], intensity: 60, color: '#ff4000', distance: 15 },
    { name: 'right-wall-glow-2', position: [8, 8, 0], intensity: 50, color: '#ff6000', distance: 12 },
    { name: 'right-wall-glow-3', position: [8, 12, 0], intensity: 40, color: '#ff8000', distance: 10 },
    
    // Back wall accent
    { name: 'back-accent', position: [0, 8, -4], intensity: 25, color: '#00ffff', distance: 8 },

    // Corner accent lights
    { name: 'corner-front-left', position: [-16, 8, 16], intensity: 35, color: '#ff0080', distance: 25 },
    { name: 'corner-front-right', position: [16, 8, 16], intensity: 35, color: '#00ff80', distance: 25 },
    { name: 'corner-back-left', position: [-16, 8, -2], intensity: 25, color: '#8000ff', distance: 20 },
    { name: 'corner-back-right', position: [16, 8, -2], intensity: 25, color: '#ff8000', distance: 20 },
